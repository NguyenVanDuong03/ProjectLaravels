...
@section('title', 'Information of Book')
    ...
    <div class="team-single">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-7">
                ...
                <p class="sm-width-95 sm-margin-auto"><span class="fw-bold">Description: </span>{{$book->author}}</p>
                <p class="sm-width-95 sm-margin-auto"><span class="fw-bold">Art type: </span>{{$book->genre}}</p>
